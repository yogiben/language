...
<html lang="en-US">
  <head>
	...
	<script src="js/game-interaction.js"></script>
	...
	<div class="overlay">
		<div id="input-container">
			<div class="overlay-inner">
				...
				<div id="content-area-1"></div>
				<div id="content-area-2"></div>
				<h1 id="prompt-1">The great Game</h1>
				<p id="prompt-2">Press any key to start</p>
			
			
			<div id="round-index"></div>
			...
			<div id="score-index" available="0"></div>
			
			
			<div id="count-index"></div>
			
			<div id="animated-index" animated="false"></div>
      ...
      <div class="navbar-inner">
        <div class="container" id="nav-bar-container">
          ...
          <div class="nav-collapse collapse visible-desktop">
			...
			<img id="flag-thumb" src="img/flags/gb.png" ></img>
			<input type="text" id="false-input"></input>
			
			<div id="loader">
				<i id="loader-play" onclick="translateSpeakText();" class="icon-play" href="#"></i>
...
<textarea style="display:none" id="blog-database" > <?php include 'data/append.csv'; ?>
</textarea>
...
//Defaults
var contentString = "<h2>Your Ultimate Guide to Hipster Travel</h2>Stories from around the world focusing on the coolest cultural things to do";
...
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,600' rel='stylesheet' type='text/css'>
  ...
  <div class="modal-header">
    ...
    <h3><a href="http://travelsofadam.com">Travels of Adam</a> - About the Map</h3>
  </div>
...
<div id="alert" class="alert animated alert-block fade visible-desktop">
	<button onclick="alertClose()" type="button" class="close">×</button>
